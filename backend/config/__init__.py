...
SHELL_SESSION_IDLE_TIMEOUT_SEC = _read_positive_int_env("SHELL_SESSION_IDLE_TIMEOUT_SEC", 300)
SHELL_SESSION_CLEANUP_INTERVAL_SEC = _read_positive_int_env("SHELL_SESSION_CLEANUP_INTERVAL_SEC", 60)
SHELL_SESSION_TERMINATION_GRACE_SEC = _read_positive_int_env("SHELL_SESSION_TERMINATION_GRACE_SEC", 1)
SHELL_SESSION_TERMINAL_IO_GRACE_SEC = _read_positive_int_env("SHELL_SESSION_TERMINAL_IO_GRACE_SEC", 2)
