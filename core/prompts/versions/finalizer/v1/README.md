...
- `system_subagent.txt` — bounded, user-readable child-result voice used when the finalizer runs inside an attributed subagent.
...
- `instructions_subagent.txt` — child-result closer that limits the response to the assigned handoff.
