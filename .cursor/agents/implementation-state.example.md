...
Neutral reset template for `.cursor/agents/implementation-state.md`. Copy the
YAML block below into the local state file, then replace every placeholder with
the approved guide scope. The live state file is intentionally ignored by Git.
